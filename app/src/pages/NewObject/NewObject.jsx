...
export default function NewObject({history}) {
    ...
    const aquaticCreatures = [
        ...
        {label: 'Без вечеринок', value: 'no_party'},
        {label: 'Без животных', value: 'no_animals'},
        {label: 'Не курить', value: 'no_smoke'},
        {label: 'С животными', value: 'animals'},
        {label: 'Плечики', value: 'hanger'},
        {label: 'Нет датчиков дыма', value: 'no_smoke_detector'},
        {label: 'Есть пожарная сигнализация', value: 'fire_alarm'},
        {label: 'Отопление', value: 'heating'},
        {label: 'Шампунь', value: 'shampoo'},
        {label: 'Отдельный вход', value: 'idk'},
        {label: 'Датчик угарного газа', value: 'smoke_detector'},
        {label: 'С детьми', value: 'children'},
        {label: 'Без детей', value: 'no_children'},
        {label: 'Сушилка для одежды', value: 'clothes_dryer'},
        {label: 'Аптечка', value: 'first_aid_kit'},
        {label: 'Чайник', value: 'teapot'},
        {label: 'Холодильник', value: 'refrigerator'},
        {label: 'Посуда и столовые приборы', value: 'dishes'},
        {label: 'Плита', value: 'stove'},
        {label: 'Прачечная поблизости', value: 'laundry'},
        {label: 'Камеры видеонаблюдения в жилье', value: 'cameras'},
    ];
