...
const createLease = () => {
    ...
    try {
        ...
        const filepath = __dirname + `\\tmp_files\\lease_${user_id}.pdf`;
        ...
        pdfLease.font('Roboto')
                .fontSize(10)
                .text('Собственник жилья, (Ф.И.О.,   паспортные   данные):____________________________________________________________________________________________________________________________________________   именуемый   в   дальнейшем "Арендодатель", с одной стороны и  (Ф.И.О., паспортные данные):______________________________________________________________________________________________________________________________________________________________,  именуемый в дальнейшем "Арендатор", с другой стороны, заключили настоящий договор о нижеследующем:',
                    {
                        align: 'left'
                    });
        ...
        pdfLease.font('Roboto')
                .fontSize(10)
                .text('1.1. Арендодатель представляет Арендатору и членам его семьи в пользование квартиру общей площадью______кв.м. по адресу: ____________________, ул.______________________д._______кв.______, характеристика которой приведена в акте сдачи квартиры (Приложение №1).',
                    {
                        align: 'left'
                    });
        ...
        pdfLease.font('Roboto')
                .fontSize(10)
                .text(`5.1. Плата за арендуемое по настоящему Договору Помещение составляет ______________(_______________________________________________________________________) рублей. За ${10} дней`,
                    {
                        align: 'left'
                    });
        ...
        pdfLease.font('Roboto')
                .fontSize(10)
                .text(`АРЕНДОДАТЕЛЬ:_____________________________________________________________________________________________`,
                    {
                        align: 'left'
                    });
        ...
        pdfLease.font('Roboto')
                .fontSize(10)
                .text(`\nАРЕНДАТОР:_____________________________________________________________________________________________`,
                    {
                        align: 'left'
                    });
